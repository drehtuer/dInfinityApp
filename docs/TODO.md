...
- [ ] Re-run the 100,000-roll fairness harness now that a roll's streams are stirred (`Seeds`), which is the last thing the d18's bias was traced to. Needs the phone or a long emulator run
