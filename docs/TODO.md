...
- [ ] Mark `xml:S6358` (application backup) as reviewed-and-safe in SonarQube. It is a deliberate decision, recorded in `SECURITY.md`, and it is the last thing keeping the quality gate red
